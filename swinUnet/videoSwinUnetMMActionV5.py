...
class Decoder(nn.Module):
    ...
    def forward(self, x, targetWeather, staticData):
        ...
        for i, x_i in enumerate(reversed(x)):
            ...
            x_i = x_i + F.interpolate(targetWeather[1], size=(T, H, W)) # Conditioning decpder on target weather data
            x_i = x_i + F.interpolate(staticData[1], size=(T, H, W)) # Conditioning decpder on static data
...
if __name__ == "__main__":
    ...
    config = load_config('/home/nikoskot/earthnetThesis/experiments/configV5.yml')
